...
### Changed
 - Security enhancements ([#156](https://github.com/rokucommunity/ropm/pull/156))
 - Bump pnpm from 10.28.0 to 10.34.4 ([#154](https://github.com/rokucommunity/ropm/pull/154))
 - Replace glob-all with fast-glob ([#153](https://github.com/rokucommunity/ropm/pull/153))
 - Security enhancements ([#152](https://github.com/rokucommunity/ropm/pull/152))
 - Bump qs and roku-deploy ([#149](https://github.com/rokucommunity/ropm/pull/149))
 - Bump form-data from 2.5.5 to 2.5.6 ([#147](https://github.com/rokucommunity/ropm/pull/147))
...
### Changed
 - upgrade to [@rokucommunity/logger@0.3.13](https://github.com/rokucommunity/logger/blob/master/CHANGELOG.md#0313---2026-06-08). Notable changes since 0.3.12:
     - Security enhancements ([#27](https://github.com/rokucommunity/logger/pull/27), [#26](https://github.com/rokucommunity/logger/pull/26), [#24](https://github.com/rokucommunity/logger/pull/24), [#21](https://github.com/rokucommunity/logger/pull/21), [#19](https://github.com/rokucommunity/logger/pull/19))
